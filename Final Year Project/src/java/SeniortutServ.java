 ...
 */
@MultipartConfig
public class SeniortutServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SeniortutServ</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SeniortutServ at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
        ...
        try(PrintWriter out = response.getWriter())
            {
              ...
              ArrayList pid = new ArrayList();  //pid is initialized as new arraylist
                        ...
                        ResultSet rs = Corner.getdata("select t.tid,s.sub_name,t.tut_title,t.tut_path from subject s,tutorial t where s.sid=t.sid");
                            ...
                            RequestDispatcher r= request.getRequestDispatcher("Client/seniorTutorial.jsp");
