...
public class showGallery extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter())
            ...
            ResultSet rs = Corner.getdata("select g.id,a.aname,g.pic_name,g.pic_path from album a,gallery g where a.aid=g.aid and g.aid="+id);   //To display data from table gallery
        
            while(rs.next())
            {
                a1 = new ArrayList();                
                a1.add(rs.getString("aname"));    //this will add id to a1
                a1.add(rs.getString("id"));
                a1.add(rs.getString("pic_name"));  //this will add pic_name to a1
            ...
            RequestDispatcher r= request.getRequestDispatcher("Client/galleryPage.jsp");
