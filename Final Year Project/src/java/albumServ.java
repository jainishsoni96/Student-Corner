 ...
 */
@MultipartConfig
public class albumServ extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter())
            ...
            RequestDispatcher r= request.getRequestDispatcher("admin/Album.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter())
        {
            ...
            String m1 = request.getParameter("aname");
            String m2 = request.getParameter("ayear");
                    ...
                    try
                    {
                        ...
                        ResultSet rs = Corner.getdata("select * from album");
                            ...
                            while(rs.next())
                               {
                                a1 = new ArrayList();                
                                a1.add(rs.getString("aid"));
                                a1.add(rs.getString("aname"));
                                a1.add(rs.getString("ayear"));
                
                                Blob test=rs.getBlob("a_path"); 
