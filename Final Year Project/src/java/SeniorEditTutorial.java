 ...
 */
@MultipartConfig
public class SeniorEditTutorial extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SeniorEditTutorial</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SeniorEditTutorial at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter())
        {
            ...
            RequestDispatcher r= request.getRequestDispatcher("Client/senioredittutorial.jsp");
        ...
        String query = "update tutorial set sid='"+sub+"',tut_title='"+tt+"',tut_path='"+m+"' where tid="+id;     
            ...
            try
            {
               if (Corner.updateData(query))
               {
                    ...
                    RequestDispatcher r= request.getRequestDispatcher("SeniortutServ");
