 ...
 * @author Kunj Tandel
 */
public class SeniorEditJob extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet SeniorEditJob</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet SeniorEditJob at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try(PrintWriter out = response.getWriter())
        {
            ...
            RequestDispatcher r= request.getRequestDispatcher("Client/Senioreditjobs.jsp");
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
       ...
       String q = "update jobs set job_title='"+jt+"',company_name='"+c_name+"',interview_date='"+i_date+"',job_skills='"+j_skill+"',experience='"+exp+"',posted_by='"+posted_by+"',url='"+url+"' where jid="+id;
       
       if(Corner.updateData(q))
       {
           
           //RequestDispatcher r= request.getRequestDispatcher("admin/Jobs.jsp");
           RequestDispatcher r= request.getRequestDispatcher("SeniorjobServ");
