<%-- 
    Document   : senioredittutorial
    Created on : 17 May, 2017, 12:31:37 PM
    Author     : Kunj Tandel
--%>
		...
		<div class="panel-body">
			...
			<p style="line-height:30px;" class="text-justify" />
                                ...
                                while(i1.hasNext())
                                 ...
                                 %>
               <form role="form" enctype="multipart/form-data" action="../../DemoProject/SeniorEditTutorial" method="post">            
