<%-- 
    Document   : seniorTutorial
    Created on : 17 May, 2017, 12:21:24 PM
    Author     : Kunj Tandel
--%>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
		  <div class="col-md-6">
		  	<form role="form" enctype="multipart/form-data" action="../../DemoProject/SeniortutServ" method="post">
			...
			<table class="table table-striped table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="SeniorEditTutorial?id=<%= j.get(0) %>">Edit</a></td>
						<td><a href="SeniorTutorialDel?id=<%= j.get(0)%>" onClick="return confirm('Sure Want To Delete?');">Delete</a></td>
					</tr>
					<%
                                                }
                                            }
