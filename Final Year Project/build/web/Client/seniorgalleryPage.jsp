<%-- 
    Document   : seniorgalleryPage
    Created on : 17 May, 2017, 6:08:02 AM
    Author     : Kunj Tandel
--%>
...
<div class="col-md-9"><!-- col-md-9 -->
    ...
    <h2 class="text-center">Choose Your Photo</h2><br>
    ...
    <div class="col-md-3 text-center">
        ...
        <a href="#">
            <img src="data:image/jpeg;base64,<%= j.get(3) %>" alt="<%= j.get(3) %>" id="logo1" >
            <br>
            <p>
            <h4>
            <%= j.get(2) %>    
