<%-- 
    Document   : department
    Created on : 22 Feb, 2017, 5:12:06 PM
    Author     : jainish
--%>
...
<div class="col-md-9"><!-- col-md-9 -->
	<div class="panel panel-default"><!-- panel start -->
		...
		<div class="panel-body"><!-- panel body -->
			<div class="col-md-12">
				<div class="col-md-6">
					<p style="font-size:25px;">Department</p> 
				</div>
        ...
        <div class="modal-dialog">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="container">
                      <div class="col-md-6">
                          <form role="form" action="../../DemoProject/deptServ" method="post">
                                <%
        ...
        <div class="modal-footer">
			...
			<table class="table table-striped table-responsive ">
				...
				<tbody>
					...
					<tr>
                                                <td><%= j.get(1) %></td>
						<td><a href="EditDept?id=<%= j.get(0) %>">Edit</a></td>
						<td><a href="DeptDel1?id=<%= j.get(0)%>" onclick="return confirm('Sure Want To Delete?');">Delete</a></td>
					</tr>
