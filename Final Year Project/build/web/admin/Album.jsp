...
<div class="col-md-9"><!-- col-md-9 -->
	<div class="panel panel-default"><!-- panel start -->
		...
		<div class="panel-body"><!-- panel body -->
			<div class="col-md-12">
				<div class="col-md-6">
					<p style="font-size:25px;">Album</p> 
				</div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
		  <div class="col-md-6">
		  	<form role="form" enctype="multipart/form-data" action="../../DemoProject/albumServ" method="post">
				...
				<div class="form-group">
					...
					<label>Album Name</label>
                                        ...
                                        <input type="file" name="apath" class="form-control"  />
			...
			<table class="table table-striped table-responsive">
				...
				<tbody>
					...
					<tr>
						...
						<td><a href="EditAlbum?id=<%= j.get(0) %>">Edit</a></td>
						<td><a href="AlbumDel?id=<%= j.get(0)%>" onClick="return confirm('Sure Want To Delete?');">Delete</a></td>
					</tr>
					<%
                                                }
                                            }
