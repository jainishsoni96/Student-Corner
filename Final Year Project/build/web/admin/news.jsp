    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container">
		  <div class="col-md-6">
                      <form role="form" method="post" action="../../DemoProject/newServ">
                                 <%
				...
				<tbody>
                  ...
                  %>    
					<tr>
						...
						<td><%=j.get(2) %></td>
						<td><%=j.get(3) %></td>
						<td><a href="EditNews?id=<%= j.get(0) %>">Edit</a></td>
						<td><a href="NewDel?id=<%= j.get(0) %>" onclick="return confirm('Sure Want To Delete?');">Delete</a></td>
					</tr>
					 <%
                                            }
}
